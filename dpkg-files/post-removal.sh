#!/bin/bash
#: Description: Post removal script for microstackcommon.
...
#=======================================================================
# NAME: teardown_i2c
# DESCRIPTION: Removes permissions for the i2c devices
#=======================================================================
teardown_spi() {
    # udev_rules_file='/etc/udev/rules.d/50-i2c.rules'
    spi_group_name='i2c'
...
select yn in "Yes" "No"; do
    case $yn in
        Yes ) teardown_spi; teardown_i2c; teardown_gpio; break;;
        No ) exit;;
    esac
done
